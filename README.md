  ...
  <table border="0" style="border-spacing: 0;">
    <tr align="center">
      <td style="border: 1px solid #ddd; border-radius: 10px; padding: 12px; vertical-align: top;">
        ...
        <p style="margin-top: 5px; margin-bottom: 2px;"><strong>박찬</strong></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin: 2px 0;"><small>팀장/프론트엔드, PM</small></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin-top: 2px; margin-bottom: 0;"><small>전체 일정 관리 및<br/>프론트엔드 개발 총괄</small></p>
      </td>
      <td style="border: 1px solid #ddd; border-radius: 10px; padding: 12px; vertical-align: top;">
        <img src="https://github.com/user-attachments/assets/27e01010-779d-4703-82ae-e5e3a852a578" width="100px" alt="김명재"/>
        <p style="margin-top: 5px; margin-bottom: 2px;"><strong>김명재</strong></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin: 2px 0;"><small>데이터 분석/시각화</small></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin-top: 2px; margin-bottom: 0;"><small>ROI 지표 설계 및<br/>데이터 시각화 담당</small></p>
      </td>
      <td style="border: 1px solid #ddd; border-radius: 10px; padding: 12px; vertical-align: top;">
        <img src="https://github.com/user-attachments/assets/8b403db5-7694-4089-89a6-5af856ad71d7" width="100px" alt="오요셉"/>
        <p style="margin-top: 5px; margin-bottom: 2px;"><strong>오요셉</strong></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin: 2px 0;"><small>백엔드</small></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin-top: 2px; margin-bottom: 0;"><small>API 및 시스템 아키텍처<br/>설계 구축</small></p>
      </td>
      <td style="border: 1px solid #ddd; border-radius: 10px; padding: 12px; vertical-align: top;">
        <img src="https://github.com/user-attachments/assets/88810eba-be69-42f1-bede-fd369eddd642" width="100px" alt="유승환"/>
        <p style="margin-top: 5px; margin-bottom: 2px;"><strong>유승환</strong></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin: 2px 0;"><small>문서작업</small></p>
        <hr style="border-top: 1px solid #eee; margin: 0;" />
        <p style="margin-top: 2px; margin-bottom: 0;"><small>자료 정리 및<br/>최종 문서화 담당</small></p>
      </td>
    </tr>
  </table>
</div>
